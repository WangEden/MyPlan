...
# 将内容转成简易的 HTML 节点
html = markdown(md_text, extras=["fenced-code-blocks", "pymdownx.magiclink", "pymdownx.emoji"])
...
# 转换 Markdown 为 HTML，启用 pymdown 扩展来支持公式
html = markdown(markdown_text, extras=["fenced-code-blocks", "pymdownx.magiclink", "pymdownx.emoji"])
